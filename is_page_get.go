...
func isAssetGet(r *http.Request) bool {
	if r.Method != "GET" {
		return false
	}
	...
	_, found := limitedAssetExtension[extension]
	if found {
		return true
	}
...
// limitedAssetExtension is a map with file extensions corresponding to files that might be pushable.
var limitedAssetExtension = map[string]struct{}{
	// css
	"css": struct{}{},
	// js
	"js": struct{}{},
